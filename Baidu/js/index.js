    ...
    var changSkin={
        ...
        event:{
            ...
            noSkin:function(){
                ...
                $('.logo').attr('src','./static/img/bdlogo.jpg');
                $('header').removeClass('change-header');
                localStorage.name = 'noSkin';
            },
            skin1:function(){
                $('.skin').css('background-image','url("./static/img/skin-bg1.jpg")');
                $('.logo').attr('src','./static/img/logo_white.jpg');
                $('header').addClass('change-header');
                localStorage.name = 'skin1';
            },
            skin2:function(){
                $('.skin').css('background-image','url("./static/img/skin-bg2.jpg")');
                $('.logo').attr('src','./static/img/logo_white.jpg');
                $('header').addClass('change-header');
                localStorage.name = 'skin2';
            },
            skin3:function(){
                $('.skin').css('background-image','url("./static/img/skin-bg3.jpg")');
                $('.logo').attr('src','./static/img/logo_white.jpg');
                $('header').addClass('change-header');
